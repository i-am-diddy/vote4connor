    ...
    if (window.location.href.includes('usatodaynetworkservice.com')) {
        ...
        function vote() {
            ...
            setTimeout(function() {
                ...
                if (voteButton) {
                    ...
                    voteButton.click();
                    console.log('Vote submitted! Telling parent to reload...');
                    
                    // Tell parent page to reload via postMessage
                    try {
        ...
        window.addEventListener('message', function(event) {
            if (event.data === 'VOTE_COMPLETE' || event.data === 'RELOAD_NEEDED') {
                ...
                console.log('Waiting for page to fully load before reloading...');
            }
        });
